...
function Crypto({ crypto }: Props) {
  ...
  return (
    <div className="max-w p-6 bg-white border border-gray-100 rounded-lg shadow-lg">
      <img className="w-10 h-10 mb-2 rounded-full" src={`https://s2.coinmarketcap.com/static/img/coins/128x128/${crypto.iconCode}.png`} alt="img"/>
      ...
      <a href={crypto.explorer} target="_blank" rel="noreferrer" className="inline-flex items-center text-blue-600 mt-6">Explorer
      <svg
